    ...
    public function add_edit($id='') {
        ...
        if($id != '') {
            ...
            if($this->input->post('user_type') != 'admin') {
                ...
                if($checkValue==false)  {
                    $this->session->set_flashdata('messagePr', 'Looks like you have already registered. <br/>Would you like to <a href="user/login">login</a>? <br/>In case if you <a href="forgetpassword">forgot your password</a>.');
